...
func TestMyTests(t *testing.T) {
	...
	t.Run("countDomains", func(t *testing.T) {
		data := `{"Id":1,"Name":"Jack Nilson","Email":"aliquid_qui_ea@Browsedrive.net"}
		{"Id":2,"Name":"Smith","Email":"aliquid_qui_ea@Browsedrive.net"}
		{"Id":3,"Name":"John Mendoza","Email":""}
		{"Id":4,"Name":"","Email":"aliquid_qui_ea@Browsedrive.com"}
		{"Id":5,"Name":"Test Mendoza","Email":""}`
		expected := DomainStat{
			"browsedrive.net": 2,
		}

		result, err := countDomains(bytes.NewBufferString(data), "net")
